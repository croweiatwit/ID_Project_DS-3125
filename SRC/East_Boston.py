...
# Sort data
e_boston_sorted_data = data.sort_values(by=['DISTRICT', 'OCCURRED_ON_DATE'], ascending=True)
...
# Create a new row for the "Other" category (sum of offenses not in the top 5)
other_sum = offense_counts[20:].sum()
...
plt.title('Top Offense Types and Other (East Boston District)')
