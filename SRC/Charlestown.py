...
# Sort data
Charlestown_sorted_data = data.sort_values(by=['DISTRICT', 'OCCURRED_ON_DATE'], ascending=True)

# Replace district names with full names

# Drop unnecessary columns
Charlestown_sorted_data.drop(['SHOOTING', 'Lat', 'Long', 'REPORTING_AREA', 'UCR_PART', 'INCIDENT_NUMBER', 'OFFENSE_CODE',
...
plt.title('Top Offense Types and Other (Charlestown District)')
